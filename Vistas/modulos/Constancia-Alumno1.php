	...
	<section class="content">
		...
		<div class="box">
			...
			<div class="box-body">
				...
				<h2>Constancia de Alumno 1er A&ntilde;o</h2>
				...
				<form method="post">
					...
					<input type="hidden" name="tipo" value="alumno 1er Año">
					...
					foreach ($cert as $key => $value) {
						...
						if($_SESSION["id"] == $value["id_alumno"] && $value["tipo"] == "alumno 1er Año"){
					...
					$certificado -> PedirCertificados1C();

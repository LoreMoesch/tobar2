		...
		<div class="box">
			...
			<div class="box-body">
				...
				<form method="post">
					...
					<input type="hidden" name="tipo" value="materias">
					...
					foreach ($cert as $key => $value) {
						...
						if($_SESSION["id"] == $value["id_alumno"] && $value["tipo"] == "materias"){

							echo '<div class="alert alert-success">Ya ha solicitado el Certificado de Materias.</div>';

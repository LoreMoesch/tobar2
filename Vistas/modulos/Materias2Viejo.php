...
<div class="container-fluid">
	...
	<section class="content-header">
		...
		echo '<h3>Materias de la Carrera: '.$carrera["nombre"].'</h3>
		<br/> ';
		
		echo '<h3>Alumno/a ('.$estudiante["id"].') : '.$estudiante["apellido"].' '.$estudiante["nombre"].' - Libreta: '.$estudiante["libreta"].'</h3>
        <br>
									...
									if($ajustes["cuatrimestre"] != "2do Cuatrimestre" || $ajustes["cuatrimestre"] == "2do Cuatrimestre" ){
										...
										if($N["tipo"] != "2do Cuatrimestre" || $N["tipo"] == "2do Cuatrimestre" ){
											...
											foreach ($notas1 as $key => $N1) {
 	                                        ...
 	                                        echo '<tr>
											          <td style="color: black;">'.$N["codigo"].'</td>
											          <!-- 
											           -->
													  <td style="color: black;">'.$N["id"].'</td>
													 
													  <td style="color: black;">'.$N["nom_abrevi"].'</td>
													  <td style="color: black;">'.$N["grado"].'</td>
													  <td style="color: black;">'.$N["tipo"].'</td>
											        ...
											        foreach ($notas2 as $key => $N2) {
                                                       $vacio=1;
                                                        ...
                                                        if ($sipuede==1){
                                                            ...
                                                            echo '
                                                            <td class="bg-info" style="color: black;">

												               comision ('.$comi.') Turno:('.$comision["turno"].') Profe:('.$profe["apellido"].' '.$profe["nombre"].') 

												            </td>
                                                            <td>
			        											<a href="http://localhost/tobar2/inscripto-M2/'.$exp[1].'/'.$N["id"].'/'.$exp[2].'">
					    		    								<button class="btn btn-danger">Borrar Incripci&oacute;n</button>
						        								</a>
									        				</td>';
                                                                ...
                                                                echo '<td>
			        											<a href="http://localhost/tobar2/insc-materia2/'.$exp[1].'/'.$N["id"].'/'.$exp[2].'">
                                                            ...
                                                            echo '
                                                            <td class="bg-danger" style="color: black;">
							    	  ...
							    	  if($N["tipo"] == "2do Cuatrimestre" ){
										...
										///
											...
											foreach ($notas1 as $key => $N1) {
			                                 ...
			                                 //  <td>'.$N["id"].'</td>
 	                                        echo '<tr>
											          <td style="color: black;">'.$N["codigo"].'aaa</td>
											          <td style="color: black;">'.$N["id"].'</td>
													  <td style="color: black;">'.$N["nom_abrevi"].'</td>
													  <td style="color: black;">'.$N["grado"].'</td>
													  <td style="color: black;">'.$N["tipo"].'</td>

...
<div class="container">
	...
	<section class="content-header">
		...
		echo '<h1>Estudiantes de: '.$carrera["nombre"].'('.$cant.')</h1>';
	...
	<div class="row">
		...
		<div class="col-lg-12">
			...
			<div class="table-responsive">
				...
				<table id="estudiantes1"class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						foreach ($resultado as $key => $value) {
							...
							if($value["id_carrera"] == $exp[1]){
								...
								echo '
								      ...
								      <td>
										<a href="http://localhost/tobar2/Plan/'.$value["id_carrera"].'/'.$value["libreta"].'/'.$value["id"].'">
											<button class="btn btn-primary">Plan de Estudios</button>
										</a>
									
										<a href="http://localhost/tobar2/materiass/'.$value["id_carrera"].'/'.$value["id"].'">
											<button class="btn btn-success">Cursadas</button>
										</a>

										<a href="http://localhost/tobar2/infoalu/'.$value["id"].'/'.$exp[1].'">

...
<head>
  ...
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="http://localhost/tobar2/dist/css/adminlte.min.css">
  
      <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="bootstrap/css/bootstrap.min.css">
	
<!-- Propios-->
  <link rel="stylesheet" type="text/css" href="http://localhost/tobar2/main.css"/>
  <!-- Google Font: Source Sans Pro -->
  <link href="http://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">

  <!--datables CSS básico-->
    <!-- <link rel="stylesheet" type="text/css" href="vendor/datatables/datatables.min.css"/> -->
    <link rel="stylesheet" type="text/css" href="http://localhost/tobar2/datatables/datatables.min.css"/>
   <!--datables estilo bootstrap 4 CSS-->  
    <link rel="stylesheet"  type="text/css" href="http://localhost/tobar2/datatables/DataTables-1.10.18/css/dataTables.bootstrap4.min.css">   
...
<!-- jQuery -->
<!-- <script src="http://localhost/tobar2/plugins/jquery/jquery.min.js"></script> -->
<script src="http://localhost/tobar2/jquery/jquery-3.3.1.min.js"></script>  

<!-- Bootstrap 4 -->
<!--<script src="http://localhost/tobar2/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>-->
 <script src="http://localhost/tobar2/bootstrap/js/bootstrap.min.js"></script>
<!-- <script src="http://localhost/tobar2/popper/popper.min.js"></script> -->

<!-- AdminLTE App -->
<script src="http://localhost/tobar2/dist/js/adminlte.min.js"></script>
<!-- AdminLTE para demostracion -->
<script src="http://localhost/tobar2/dist/js/demo.js"></script>

<!-- datatables JS -->
      
<script type="text/javascript" src="http://localhost/tobar2/datatables/datatables.min.js"></script> 

<!-- para usar botones en datatables JS -->  
<script src="http://localhost/tobar2/datatables/Buttons-1.5.6/js/dataTables.buttons.min.js"></script>  
<script src="http://localhost/tobar2/datatables/JSZip-2.5.0/jszip.min.js"></script>    
<script src="http://localhost/tobar2/datatables/pdfmake-0.1.36/pdfmake.min.js"></script>    
<script src="http://localhost/tobar2/datatables/pdfmake-0.1.36/vfs_fonts.js"></script>
<script src="http://localhost/tobar2/datatables/Buttons-1.5.6/js/buttons.html5.min.js"></script>

<!-- código propio JS --> 
<script type="text/javascript" src="http://localhost/tobar2/main.js"></script>  
<script type="text/javascript" src="http://localhost/tobar2/usuarios.js"></script>  
<script type="text/javascript" src="http://localhost/tobar2/usuarios2.js"></script> 
<script type="text/javascript" src="http://localhost/tobar2/comision.js"></script> 
<script type="text/javascript" src="http://localhost/tobar2/comision1.js"></script> 
<script type="text/javascript" src="http://localhost/tobar2/comision2.js"></script> 
<script type="text/javascript" src="http://localhost/tobar2/turnos.js"></script> 
<script type="text/javascript" src="http://localhost/tobar2/materias.js"></script>
<script type="text/javascript" src="http://localhost/tobar2/regimen.js"></script>
<script type="text/javascript" src="http://localhost/tobar2/estudiantes.js"></script>
<script type="text/javascript" src="http://localhost/tobar2/estudiantes1.js"></script>
<script type="text/javascript" src="http://localhost/tobar2/estudiantes2.js"></script>
<script type="text/javascript" src="http://localhost/tobar2/plan.js"></script>
<script type="text/javascript" src="http://localhost/tobar2/plan1.js"></script>
<script type="text/javascript" src="http://localhost/tobar2/plan2.js"></script>
